    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <span class="d-none d-xl-inline-block ml-1">Empresas</span>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ asset('img/avatar/usergeneric.png') }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ml-1">{{ Session::get('nombre') }} {{ Session::get('apellido') }}</span>
