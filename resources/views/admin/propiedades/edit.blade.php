					...
					<div class="row">
						...
						<div class="col-6">
							<div class="form-group">
								...
								{!! Form::select('idTipoInversion', $tipo_inversion,$propiedad->idTipoInversion,['class'=>"form-control js-example-basic-multiple",'placeholder'=>"Seleccione un tipo de inversion"]) !!}
							</div>
						</div>
						...
						<div class="col-4">
							<div class="form-group">
								...
								{!! Form::select('idTipoFlexibilidad', $tipo_flexibilidad,$propiedad->idTipoFlexibilidad,['class'=>"form-control",'placeholder'=>"Seleccione un tipo de flexibilidad"]) !!}
							</div>
						</div>
						...
						<div class="col-4">
							<div class="form-group">
								...
								{!! Form::select('idTipoCalidad', $tipo_calidad,$propiedad->idTipoCalidad,['class'=>"form-control",'placeholder'=>"Seleccione un tipo de calidad"]) !!}
							</div>
						</div>
						<div class="col-4">
							<div class="form-group">
								<label>Tipo de Credito</label>
								{!! Form::select('idTipoCredito', $tipo_credito,$propiedad->idTipoCredito,['class'=>"form-control js-example-basic-multiple",'placeholder'=>"Seleccione un tipo de credito"]) !!}
							</div>
						</div>
						<div class="col-4">
							<div class="form-group">
