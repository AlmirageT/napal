        ...
        <input type="hidden" name="idUsuario" value="{{ $idUsuario }}">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">Nombre del Banco de Origen</label>
                        {!!Form::text('nombreBancoOrigen',$trxDepositoTransferencia->nombreBancoOrigen,['class'=>"form-control", 'placeholder'=>"Ingrese el nombre del banco de origen..." , 'required','disabled'])!!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">Número de la Operación</label>
                        {!!Form::number('numeroOperacion',$trxDepositoTransferencia->numeroOperacion,['class'=>"form-control", 'placeholder'=>"Ingrese el numero de la operacion..." , 'required','disabled'])!!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">Banco Origen</label>
                        {!!Form::text('bancoOrigen',$trxDepositoTransferencia->bancoOrigen,['class'=>"form-control", 'placeholder'=>"Ingrese el nombre del banco de origen..." , 'required','disabled'])!!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">Fecha Depósito</label>
                        {!!Form::date('fechaDeposito',date('Y-m-d',strtotime($trxDepositoTransferencia->fechaDeposito)),['class'=>"form-control" , 'required','disabled'])!!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">Número Cuenta Bancaria</label>
                        {!!Form::number('numeroCuentaBanco',$trxDepositoTransferencia->numeroCuentaBanco,['class'=>"form-control", 'placeholder'=>"Ingrese el numero de cuenta..." , 'required','disabled'])!!}
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">Monto Depósito</label>
                        {!!Form::number('montoDeposito',$trxDepositoTransferencia->montoDeposito,['class'=>"form-control", 'placeholder'=>"Ingrese el monto..." , 'required','disabled'])!!}
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
