<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="edit{{$pais->idPais}}" role="dialog" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
			{!! Form::open(['route' => ['mantenedor-paises.update',$pais->idPais], 'method' => 'PUT','files'=>true]) !!}
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            {!!Form::text('nombrePais',$pais->nombrePais,['class'=>"form-control", 'placeholder'=>"Ingrese un nombre..." , 'required'])!!}
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
