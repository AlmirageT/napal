...
<br>
	<div class="card-header">
		<div align="center">
			<h6>Al realizar la transferencia con paypal se le aumentara un "monto dado en parametros generales"</h6>
		</div>
	</div>
	<div class="card-body">
		<form action="{{ asset('dashboard/paypal') }}" method="POST">
			@csrf
			<div class="row">
				<div class="col-lg-6">
					<div class="form-group">
						<label>Valor a ingresar</label>
						<input type="number" name="monto" class="form-control" onchange="valorPorcentaje(this.value)">
