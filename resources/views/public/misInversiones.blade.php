	...
	<div class="row">
		<div class="col-lg-4">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-12"><h6>Santina Resort & Spa</h6></div>
						...
						<div class="col-lg-12" align="center">
							<br>
							<a class="btn btn-primary" href="{{ asset('dashboard/mi-inversion/detalle') }}"><small style="color: white">VER DETALLE</small></a>
						</div>
					</div>
				</div>
			</div>
