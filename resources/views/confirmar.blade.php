							...
							<br>
								...
								<div class="form-check">
								  ...
								  <label class="form-check-label" for="cuentaEsMidas">
									...
									<img src="{{ asset('img_public/logomidas-02.png') }}" alt="otros pagos" style="width: 30px;">
								  </label>
								  <p>Saldo disponible: 
